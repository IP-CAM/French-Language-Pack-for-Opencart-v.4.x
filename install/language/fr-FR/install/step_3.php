...
// Text
$_['text_step_3']            = 'Entrez vos informations concernant la base de données et l&rsquo;administration';
$_['text_db_connection']     = '1. Veuillez entrer vos détails de connexion à la base de données.';
...
$_['text_help']              = 'Informations sur la configuration d&rsquo;une base de données sur différentes plates-formes :';
$_['text_cpanel']            = 'Installation CPanel DB';
$_['text_plesk']             = 'Installation Plesk DB';

// Entry
$_['entry_db_driver']        = 'Pilote de base de données';
$_['entry_db_hostname']      = 'Nom d&rsquo;hôte';
$_['entry_db_username']      = 'Nom d&rsquo;utilisateur';
