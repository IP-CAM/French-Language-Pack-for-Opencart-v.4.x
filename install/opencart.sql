...
--
-- Dumping data for table `oc_attribute_description` MODIFICATION
--
...
--
-- Dumping data for table `oc_attribute_group_description` MODIFICATION
--
...
--
-- Dumping data for table `oc_banner_image` MODIFICATION
--
...
(198, 8, 2, 'Nintendo', '', 'catalog/demo/manufacturer/nintendo.png', 0);
...
--
-- Dumping data for table `oc_category_description` MODIFICATION
--
...
(33, 2, 'Appareils photo', '', 'Appareils photo', '', ''),
(32, 2, 'Webcam', '', 'Webcam', '', ''),
(31, 2, 'scanners', '', 'Scanners', '', ''),
(30, 2, 'Imprimantes', '', 'Imprimantes', '', ''),
(29, 2, 'Souris et Trackballs', '', 'Souris et Trackballs', '', ''),
(27, 2, 'Mac', '', 'Mac', '', ''),
(26, 2, 'PC', '', 'PC', '', ''),
(17, 2, 'Logiciel', '', 'Logiciel', '', ''),
(25, 2, 'Composants', '', 'Composants', '', ''),
(24, 2, 'Téléphones &amp; PDAs', '', 'Téléphones &amp; PDAs', '', ''),
(20, 2, 'Ordinateurs de bureau', '&lt;p&gt;\r\n	Exemple de texte de description pour la catégorie&lt;/p&gt;\r\n', 'Ordinateurs de bureau', 'Exemple de description de la catégorie', ''),
(35, 2, 'test 1', '', 'test 1', '', ''),
(36, 2, 'test 2', '', 'test 2', '', ''),
(37, 2, 'test 5', '', 'test 5', '', ''),
(38, 2, 'test 4', '', 'test 4', '', ''),
...
(34, 2, 'Lecteur MP3', '&lt;p&gt;\r\n	Shop Laptop propose uniquement les meilleures offres pour ordinateur portable sur le marché. En comparant les offres d’ordinateurs portables de PC World, Comet, Dixons, The Link et Carphone Warehouse, Shop Laptop vous propose le choix le plus complet d''ordinateurs portables sur Internet. Chez Shop Laptop, nous sommes fiers d''offrir aux clients les meilleures offres pour ordinateurs portables. Des ordinateurs portables remis à neuf aux netbooks, Shop Laptop vous garantit que chaque ordinateur portable - de toutes les couleurs, styles, tailles et spécifications techniques - présenté sur le site soit au prix le plus bas possible.&lt;/p&gt;\r\n', 'Lecteur MP3', '', ''),
...
--
-- Dumping data for table `oc_country` MODIFICATION
--

INSERT INTO `oc_country` (`country_id`, `name`, `iso_code_2`, `iso_code_3`, `address_format_id`, `postcode_required`, `status`) VALUES
(1, 'Afghanistan', 'AF', 'AFG', 1, 0, 0),
(2, 'Albania', 'AL', 'ALB', 1, 0, 0),
(3, 'Algeria', 'DZ', 'DZA', 1, 0, 0),
(4, 'American Samoa', 'AS', 'ASM', 1, 0, 0),
(5, 'Andorra', 'AD', 'AND', 1, 0, 0),
(6, 'Angola', 'AO', 'AGO', 1, 0, 0),
(7, 'Anguilla', 'AI', 'AIA', 1, 0, 0),
(8, 'Antarctica', 'AQ', 'ATA', 1, 0, 0),
(9, 'Antigua and Barbuda', 'AG', 'ATG', 1, 0, 0),
(10, 'Argentina', 'AR', 'ARG', 1, 0, 0),
(11, 'Armenia', 'AM', 'ARM', 1, 0, 0),
(12, 'Aruba', 'AW', 'ABW', 1, 0, 0),
(13, 'Australia', 'AU', 'AUS', 1, 0, 0),
(14, 'Austria', 'AT', 'AUT', 1, 0, 0),
(15, 'Azerbaijan', 'AZ', 'AZE', 1, 0, 0),
(16, 'Bahamas', 'BS', 'BHS', 1, 0, 0),
(17, 'Bahrain', 'BH', 'BHR', 1, 0, 0),
(18, 'Bangladesh', 'BD', 'BGD', 1, 0, 0),
(19, 'Barbados', 'BB', 'BRB', 1, 0, 0),
(20, 'Belarus', 'BY', 'BLR', 1, 0, 0),
(21, 'Belgium', 'BE', 'BEL', 1, 0, 0),
(22, 'Belize', 'BZ', 'BLZ', 1, 0, 0),
(23, 'Benin', 'BJ', 'BEN', 1, 0, 0),
(24, 'Bermuda', 'BM', 'BMU', 1, 0, 0),
(25, 'Bhutan', 'BT', 'BTN', 1, 0, 0),
(26, 'Bolivia', 'BO', 'BOL', 1, 0, 0),
(27, 'Bosnia and Herzegovina', 'BA', 'BIH', 1, 0, 0),
(28, 'Botswana', 'BW', 'BWA', 1, 0, 0),
(29, 'Bouvet Island', 'BV', 'BVT', 1, 0, 0),
(30, 'Brazil', 'BR', 'BRA', 1, 0, 0),
(31, 'British Indian Ocean Territory', 'IO', 'IOT', 1, 0, 0),
(32, 'Brunei Darussalam', 'BN', 'BRN', 1, 0, 0),
(33, 'Bulgaria', 'BG', 'BGR', 1, 0, 0),
(34, 'Burkina Faso', 'BF', 'BFA', 1, 0, 0),
(35, 'Burundi', 'BI', 'BDI', 1, 0, 0),
(36, 'Cambodia', 'KH', 'KHM', 1, 0, 0),
(37, 'Cameroon', 'CM', 'CMR', 1, 0, 0),
(38, 'Canada', 'CA', 'CAN', 1, 0, 0),
(39, 'Cape Verde', 'CV', 'CPV', 1, 0, 0),
(40, 'Cayman Islands', 'KY', 'CYM', 1, 0, 0),
(41, 'Central African Republic', 'CF', 'CAF', 1, 0, 0),
(42, 'Chad', 'TD', 'TCD', 1, 0, 0),
(43, 'Chile', 'CL', 'CHL', 1, 0, 0),
(44, 'China', 'CN', 'CHN', 1, 0, 0),
(45, 'Christmas Island', 'CX', 'CXR', 1, 0, 0),
(46, 'Cocos (Keeling) Islands', 'CC', 'CCK', 1, 0, 0),
(47, 'Colombia', 'CO', 'COL', 1, 0, 0),
(48, 'Comoros', 'KM', 'COM', 1, 0, 0),
(49, 'Congo', 'CG', 'COG', 1, 0, 0),
(50, 'Cook Islands', 'CK', 'COK', 1, 0, 0),
(51, 'Costa Rica', 'CR', 'CRI', 1, 0, 0),
(52, 'Cote D''Ivoire', 'CI', 'CIV', 1, 0, 0),
(53, 'Croatia', 'HR', 'HRV', 1, 0, 0),
(54, 'Cuba', 'CU', 'CUB', 1, 0, 0),
(55, 'Cyprus', 'CY', 'CYP', 1, 0, 0),
(56, 'Czech Republic', 'CZ', 'CZE', 1, 0, 0),
(57, 'Denmark', 'DK', 'DNK', 1, 0, 0),
(58, 'Djibouti', 'DJ', 'DJI', 1, 0, 0),
(59, 'Dominica', 'DM', 'DMA', 1, 0, 0),
(60, 'Dominican Republic', 'DO', 'DOM', 1, 0, 0),
(61, 'East Timor', 'TL', 'TLS', 1, 0, 0),
(62, 'Ecuador', 'EC', 'ECU', 1, 0, 0),
(63, 'Egypt', 'EG', 'EGY', 1, 0, 0),
(64, 'El Salvador', 'SV', 'SLV', 1, 0, 0),
(65, 'Equatorial Guinea', 'GQ', 'GNQ', 1, 0, 0),
(66, 'Eritrea', 'ER', 'ERI', 1, 0, 0),
(67, 'Estonia', 'EE', 'EST', 1, 0, 0),
(68, 'Ethiopia', 'ET', 'ETH', 1, 0, 0),
(69, 'Falkland Islands (Malvinas)', 'FK', 'FLK', 1, 0, 0),
(70, 'Faroe Islands', 'FO', 'FRO', 1, 0, 0),
(71, 'Fiji', 'FJ', 'FJI', 1, 0, 0),
(72, 'Finland', 'FI', 'FIN', 1, 0, 0),
(74, 'France, Metropolitan', 'FR', 'FRA', 1, 1, 1),
(75, 'French Guiana', 'GF', 'GUF', 1, 0, 0),
(76, 'French Polynesia', 'PF', 'PYF', 1, 0, 0),
(77, 'French Southern Territories', 'TF', 'ATF', 1, 0, 0),
(78, 'Gabon', 'GA', 'GAB', 1, 0, 0),
(79, 'Gambia', 'GM', 'GMB', 1, 0, 0),
(80, 'Georgia', 'GE', 'GEO', 1, 0, 0),
(81, 'Germany', 'DE', 'DEU', 1, 1, 0),
(82, 'Ghana', 'GH', 'GHA', 1, 0, 0),
(83, 'Gibraltar', 'GI', 'GIB', 1, 0, 0),
(84, 'Greece', 'GR', 'GRC', 1, 0, 0),
(85, 'Greenland', 'GL', 'GRL', 1, 0, 0),
(86, 'Grenada', 'GD', 'GRD', 1, 0, 0),
(87, 'Guadeloupe', 'GP', 'GLP', 1, 0, 0),
(88, 'Guam', 'GU', 'GUM', 1, 0, 0),
(89, 'Guatemala', 'GT', 'GTM', 1, 0, 0),
(90, 'Guinea', 'GN', 'GIN', 1, 0, 0),
(91, 'Guinea-Bissau', 'GW', 'GNB', 1, 0, 0),
(92, 'Guyana', 'GY', 'GUY', 1, 0, 0),
(93, 'Haiti', 'HT', 'HTI', 1, 0, 0),
(94, 'Heard and Mc Donald Islands', 'HM', 'HMD', 1, 0, 0),
(95, 'Honduras', 'HN', 'HND', 1, 0, 0),
(96, 'Hong Kong', 'HK', 'HKG', 1, 0, 0),
(97, 'Hungary', 'HU', 'HUN', 1, 0, 0),
(98, 'Iceland', 'IS', 'ISL', 1, 0, 0),
(99, 'India', 'IN', 'IND', 1, 0, 0),
(100, 'Indonesia', 'ID', 'IDN', 1, 0, 0),
(101, 'Iran (Islamic Republic of)', 'IR', 'IRN', 1, 0, 0),
(102, 'Iraq', 'IQ', 'IRQ', 1, 0, 0),
(103, 'Ireland', 'IE', 'IRL', 1, 0, 0),
(104, 'Israel', 'IL', 'ISR', 1, 0, 0),
(105, 'Italy', 'IT', 'ITA', 1, 0, 0),
(106, 'Jamaica', 'JM', 'JAM', 1, 0, 0),
(107, 'Japan', 'JP', 'JPN', 1, 0, 0),
(108, 'Jordan', 'JO', 'JOR', 1, 0, 0),
(109, 'Kazakhstan', 'KZ', 'KAZ', 1, 0, 0),
(110, 'Kenya', 'KE', 'KEN', 1, 0, 0),
(111, 'Kiribati', 'KI', 'KIR', 1, 0, 0),
(112, 'North Korea', 'KP', 'PRK', 1, 0, 0),
(113, 'South Korea', 'KR', 'KOR', 1, 0, 0),
(114, 'Kuwait', 'KW', 'KWT', 1, 0, 0),
(115, 'Kyrgyzstan', 'KG', 'KGZ', 1, 0, 0),
(116, 'Lao People''s Democratic Republic', 'LA', 'LAO', 1, 0, 0),
(117, 'Latvia', 'LV', 'LVA', 1, 0, 0),
(118, 'Lebanon', 'LB', 'LBN', 1, 0, 0),
(119, 'Lesotho', 'LS', 'LSO', 1, 0, 0),
(120, 'Liberia', 'LR', 'LBR', 1, 0, 0),
(121, 'Libyan Arab Jamahiriya', 'LY', 'LBY', 1, 0, 0),
(122, 'Liechtenstein', 'LI', 'LIE', 1, 0, 0),
(123, 'Lithuania', 'LT', 'LTU', 1, 0, 0),
(124, 'Luxembourg', 'LU', 'LUX', 1, 0, 0),
(125, 'Macau', 'MO', 'MAC', 1, 0, 0),
(126, 'FYROM', 'MK', 'MKD', 1, 0, 0),
(127, 'Madagascar', 'MG', 'MDG', 1, 0, 0),
(128, 'Malawi', 'MW', 'MWI', 1, 0, 0),
(129, 'Malaysia', 'MY', 'MYS', 1, 0, 0),
(130, 'Maldives', 'MV', 'MDV', 1, 0, 0),
(131, 'Mali', 'ML', 'MLI', 1, 0, 0),
(132, 'Malta', 'MT', 'MLT', 1, 0, 0),
(133, 'Marshall Islands', 'MH', 'MHL', 1, 0, 0),
(134, 'Martinique', 'MQ', 'MTQ', 1, 0, 0),
(135, 'Mauritania', 'MR', 'MRT', 1, 0, 0),
(136, 'Mauritius', 'MU', 'MUS', 1, 0, 0),
(137, 'Mayotte', 'YT', 'MYT', 1, 0, 0),
(138, 'Mexico', 'MX', 'MEX', 1, 0, 0),
(139, 'Micronesia, Federated States of', 'FM', 'FSM', 1, 0, 0),
(140, 'Moldova, Republic of', 'MD', 'MDA', 1, 0, 0),
(141, 'Monaco', 'MC', 'MCO', 1, 0, 0),
(142, 'Mongolia', 'MN', 'MNG', 1, 0, 0),
(143, 'Montserrat', 'MS', 'MSR', 1, 0, 0),
(144, 'Morocco', 'MA', 'MAR', 1, 0, 0),
(145, 'Mozambique', 'MZ', 'MOZ', 1, 0, 0),
(146, 'Myanmar', 'MM', 'MMR', 1, 0, 0),
(147, 'Namibia', 'NA', 'NAM', 1, 0, 0),
(148, 'Nauru', 'NR', 'NRU', 1, 0, 0),
(149, 'Nepal', 'NP', 'NPL', 1, 0, 0),
(150, 'Netherlands', 'NL', 'NLD', 1, 0, 0),
(151, 'Netherlands Antilles', 'AN', 'ANT', 1, 0, 0),
(152, 'New Caledonia', 'NC', 'NCL', 1, 0, 0),
(153, 'New Zealand', 'NZ', 'NZL', 1, 0, 0),
(154, 'Nicaragua', 'NI', 'NIC', 1, 0, 0),
(155, 'Niger', 'NE', 'NER', 1, 0, 0),
(156, 'Nigeria', 'NG', 'NGA', 1, 0, 0),
(157, 'Niue', 'NU', 'NIU', 1, 0, 0),
(158, 'Norfolk Island', 'NF', 'NFK', 1, 0, 0),
(159, 'Northern Mariana Islands', 'MP', 'MNP', 1, 0, 0),
(160, 'Norway', 'NO', 'NOR', 1, 0, 0),
(161, 'Oman', 'OM', 'OMN', 1, 0, 0),
(162, 'Pakistan', 'PK', 'PAK', 1, 0, 0),
(163, 'Palau', 'PW', 'PLW', 1, 0, 0),
(164, 'Panama', 'PA', 'PAN', 1, 0, 0),
(165, 'Papua New Guinea', 'PG', 'PNG', 1, 0, 0),
(166, 'Paraguay', 'PY', 'PRY', 1, 0, 0),
(167, 'Peru', 'PE', 'PER', 1, 0, 0),
(168, 'Philippines', 'PH', 'PHL', 1, 0, 0),
(169, 'Pitcairn', 'PN', 'PCN', 1, 0, 0),
(170, 'Poland', 'PL', 'POL', 1, 0, 0),
(171, 'Portugal', 'PT', 'PRT', 1, 0, 0),
(172, 'Puerto Rico', 'PR', 'PRI', 1, 0, 0),
(173, 'Qatar', 'QA', 'QAT', 1, 0, 0),
(174, 'Reunion', 'RE', 'REU', 1, 0, 0),
(175, 'România', 'RO', 'ROM', 1, 0, 0),
(176, 'Russian Federation', 'RU', 'RUS', 1, 0, 0),
(177, 'Rwanda', 'RW', 'RWA', 1, 0, 0),
(178, 'Saint Kitts and Nevis', 'KN', 'KNA', 1, 0, 0),
(179, 'Saint Lucia', 'LC', 'LCA', 1, 0, 0),
(180, 'Saint Vincent and the Grenadines', 'VC', 'VCT', 1, 0, 0),
(181, 'Samoa', 'WS', 'WSM', 1, 0, 0),
(182, 'San Marino', 'SM', 'SMR', 1, 0, 0),
(183, 'Sao Tome and Principe', 'ST', 'STP', 1, 0, 0),
(184, 'Saudi Arabia', 'SA', 'SAU', 1, 0, 0),
(185, 'Senegal', 'SN', 'SEN', 1, 0, 0),
(186, 'Seychelles', 'SC', 'SYC', 1, 0, 0),
(187, 'Sierra Leone', 'SL', 'SLE', 1, 0, 0),
(188, 'Singapore', 'SG', 'SGP', 1, 0, 0),
(189, 'Slovak Republic', 'SK', 'SVK', 1, 0, 0),
(190, 'Slovenia', 'SI', 'SVN', 1, 0, 0),
(191, 'Solomon Islands', 'SB', 'SLB', 1, 0, 0),
(192, 'Somalia', 'SO', 'SOM', 1, 0, 0),
(193, 'South Africa', 'ZA', 'ZAF', 1, 0, 0),
(194, 'South Georgia &amp; South Sandwich Islands', 'GS', 'SGS', 1, 0, 0),
(195, 'Spain', 'ES', 'ESP', 1, 0, 0),
(196, 'Sri Lanka', 'LK', 'LKA', 1, 0, 0),
(197, 'St. Helena', 'SH', 'SHN', 1, 0, 0),
(198, 'St. Pierre and Miquelon', 'PM', 'SPM', 1, 0, 0),
(199, 'Sudan', 'SD', 'SDN', 1, 0, 0),
(200, 'Suriname', 'SR', 'SUR', 1, 0, 0),
(201, 'Svalbard and Jan Mayen Islands', 'SJ', 'SJM', 1, 0, 0),
(202, 'Swaziland', 'SZ', 'SWZ', 1, 0, 0),
(203, 'Sweden', 'SE', 'SWE', 1, 1, 0),
(204, 'Switzerland', 'CH', 'CHE', 1, 0, 0),
(205, 'Syrian Arab Republic', 'SY', 'SYR', 1, 0, 0),
(206, 'Taiwan', 'TW', 'TWN', 1, 0, 0),
(207, 'Tajikistan', 'TJ', 'TJK', 1, 0, 0),
(208, 'Tanzania, United Republic of', 'TZ', 'TZA', 1, 0, 0),
(209, 'Thailand', 'TH', 'THA', 1, 0, 0),
(210, 'Togo', 'TG', 'TGO', 1, 0, 0),
(211, 'Tokelau', 'TK', 'TKL', 1, 0, 0),
(212, 'Tonga', 'TO', 'TON', 1, 0, 0),
(213, 'Trinidad and Tobago', 'TT', 'TTO', 1, 0, 0),
(214, 'Tunisia', 'TN', 'TUN', 1, 0, 0),
(215, 'Turkey', 'TR', 'TUR', 1, 0, 0),
(216, 'Turkmenistan', 'TM', 'TKM', 1, 0, 0),
(217, 'Turks and Caicos Islands', 'TC', 'TCA', 1, 0, 0),
(218, 'Tuvalu', 'TV', 'TUV', 1, 0, 0),
(219, 'Uganda', 'UG', 'UGA', 1, 0, 0),
(220, 'Ukraine', 'UA', 'UKR', 1, 0, 0),
(221, 'United Arab Emirates', 'AE', 'ARE', 1, 0, 0),
(222, 'United Kingdom', 'GB', 'GBR', 1, 1, 0),
(223, 'United States', 'US', 'USA', 1, 0, 0),
(224, 'United States Minor Outlying Islands', 'UM', 'UMI', 1, 0, 0),
(225, 'Uruguay', 'UY', 'URY', 1, 0, 0),
(226, 'Uzbekistan', 'UZ', 'UZB', 1, 0, 0),
(227, 'Vanuatu', 'VU', 'VUT', 1, 0, 0),
(228, 'Vatican City State (Holy See)', 'VA', 'VAT', 1, 0, 0),
(229, 'Venezuela', 'VE', 'VEN', 1, 0, 0),
(230, 'Viet Nam', 'VN', 'VNM', 1, 0, 0),
(231, 'Virgin Islands (British)', 'VG', 'VGB', 1, 0, 0),
(232, 'Virgin Islands (U.S.)', 'VI', 'VIR', 1, 0, 0),
(233, 'Wallis and Futuna Islands', 'WF', 'WLF', 1, 0, 0),
(234, 'Western Sahara', 'EH', 'ESH', 1, 0, 0),
(235, 'Yemen', 'YE', 'YEM', 1, 0, 0),
(237, 'Democratic Republic of Congo', 'CD', 'COD', 1, 0, 0),
(238, 'Zambia', 'ZM', 'ZMB', 1, 0, 0),
(239, 'Zimbabwe', 'ZW', 'ZWE', 1, 0, 0),
(242, 'Montenegro', 'ME', 'MNE', 1, 0, 0),
(243, 'Serbia', 'RS', 'SRB', 1, 0, 0),
(244, 'Aaland Islands', 'AX', 'ALA', 1, 0, 0),
(245, 'Bonaire, Sint Eustatius and Saba', 'BQ', 'BES', 1, 0, 0),
(246, 'Curacao', 'CW', 'CUW', 1, 0, 0),
(247, 'Palestinian Territory, Occupied', 'PS', 'PSE', 1, 0, 0),
(248, 'South Sudan', 'SS', 'SSD', 1, 0, 0),
(249, 'St. Barthelemy', 'BL', 'BLM', 1, 0, 0),
(250, 'St. Martin (French part)', 'MF', 'MAF', 1, 0, 0),
(251, 'Canary Islands', 'IC', 'ICA', 1, 0, 0),
(252, 'Ascension Island (British)', 'AC', 'ASC', 1, 0, 0),
(253, 'Kosovo, Republic of', 'XK', 'UNK', 1, 0, 0),
(254, 'Isle of Man', 'IM', 'IMN', 1, 0, 0),
(255, 'Tristan da Cunha', 'TA', 'SHN', 1, 0, 0),
(256, 'Guernsey', 'GG', 'GGY', 1, 0, 0),
...
--
-- Dumping data for table `oc_customer_group_description` MODIFICATION
--
...
--
-- Dumping data for table `oc_custom_field_description` MODIFICATION
--
...
--
-- Dumping data for table `oc_custom_field_value_description` MODIFICATION
--
...
--
-- Dumping data for table `oc_information_description` MODIFICATION
--
...
(1, 2, 'À propos de nous', '&lt;p&gt;\r\n	À propos de nous&lt;/p&gt;\r\n', 'À propos de nous', '', ''),
(2, 2, 'Termes et Conditions', '&lt;p&gt;\r\n	Termes &amp;amp; Conditions&lt;/p&gt;\r\n', 'Termes &amp; Conditions', '', ''),
(3, 2, 'Politique de confidentialité', '&lt;p&gt;\r\n	Politique de confidentialité&lt;/p&gt;\r\n', 'Politique de confidentialité', '', ''),
(4, 2, 'Informations de livraison', '&lt;p&gt;\r\n	Informations de livraison&lt;/p&gt;\r\n', 'Informations de livraison', '', '');
...
--
-- Dumping data for table `oc_length_class_description` MODIFICATION
--
...
--
-- Dumping data for table `oc_option_description` MODIFICATION
--
...
--
-- Dumping data for table `oc_option_value_description` MODIFICATION
--
...
--
-- Dumping data for table `oc_order_status` MODIFICATION
--
...
--
-- Dumping data for table `oc_product` MODIFICATION
--
...
(28, 'Produit 1', '', '', '', '', '', '', '', 0, 0, 939, 7, 'catalog/demo/htc_touch_hd_1.jpg', 5, 1, '100.0000', 200, 9, '2009-02-03', '146.40000000', 2, '0.00000000', '0.00000000', '0.00000000', 1, 1, 1, 0, 1, 0, '2009-02-03 16:06:50', '2011-09-30 01:05:39'),
(29, 'Produit 2', '', '', '', '', '', '', '', 0, 0, 999, 6, 'catalog/demo/palm_treo_pro_1.jpg', 6, 1, '279.9900', 0, 9, '2009-02-03', '133.00000000', 2, '0.00000000', '0.00000000', '0.00000000', 3, 1, 1, 0, 1, 0, '2009-02-03 16:42:17', '2011-09-30 01:06:08'),
(30, 'Produit 3', '', '', '', '', '', '', '', 0, 0, 7, 6, 'catalog/demo/canon_eos_5d_1.jpg', 9, 1, '100.0000', 0, 9, '2009-02-03', '0.00000000', 1, '0.00000000', '0.00000000', '0.00000000', 1, 1, 1, 0, 1, 0, '2009-02-03 16:59:00', '2011-09-30 01:05:23'),
(31, 'Produit 4', '', '', '', '', '', '', '', 0, 0, 1000, 6, 'catalog/demo/nikon_d300_1.jpg', 0, 1, '80.0000', 0, 9, '2009-02-03', '0.00000000', 1, '0.00000000', '0.00000000', '0.00000000', 3, 1, 1, 0, 1, 0, '2009-02-03 17:00:10', '2011-09-30 01:06:00'),
(32, 'Produit 5', '', '', '', '', '', '', '', 0, 0, 999, 6, 'catalog/demo/ipod_touch_1.jpg', 8, 1, '100.0000', 0, 9, '2009-02-03', '5.00000000', 1, '0.00000000', '0.00000000', '0.00000000', 1, 1, 1, 0, 1, 0, '2009-02-03 17:07:26', '2011-09-30 01:07:22'),
(33, 'Produit 6', '', '', '', '', '', '', '', 0, 0, 1000, 6, 'catalog/demo/samsung_syncmaster_941bw.jpg', 0, 1, '200.0000', 0, 9, '2009-02-03', '5.00000000', 1, '0.00000000', '0.00000000', '0.00000000', 2, 1, 1, 0, 1, 0, '2009-02-03 17:08:31', '2011-09-30 01:06:29'),
(34, 'Produit 7', '', '', '', '', '', '', '', 0, 0, 1000, 6, 'catalog/demo/ipod_shuffle_1.jpg', 8, 1, '100.0000', 0, 9, '2009-02-03', '5.00000000', 1, '0.00000000', '0.00000000', '0.00000000', 2, 1, 1, 0, 1, 0, '2009-02-03 18:07:54', '2011-09-30 01:07:17'),
(35, 'Produit 8', '', '', '', '', '', '', '', 0, 0, 1000, 5, '', 0, 0, '100.0000', 0, 9, '2009-02-03', '5.00000000', 1, '0.00000000', '0.00000000', '0.00000000', 1, 1, 1, 0, 1, 0, '2009-02-03 18:08:31', '2011-09-30 01:06:17'),
(36, 'Produit 9', '', '', '', '', '', '', '', 0, 0, 994, 6, 'catalog/demo/ipod_nano_1.jpg', 8, 0, '100.0000', 100, 9, '2009-02-03', '5.00000000', 1, '0.00000000', '0.00000000', '0.00000000', 2, 1, 1, 0, 1, 0, '2009-02-03 18:09:19', '2011-09-30 01:07:12'),
(40, 'Produit 11', '', '', '', '', '', '', '', 0, 0, 970, 5, 'catalog/demo/iphone_1.jpg', 8, 1, '101.0000', 0, 9, '2009-02-03', '10.00000000', 1, '0.00000000', '0.00000000', '0.00000000', 1, 1, 1, 0, 1, 0, '2009-02-03 21:07:12', '2011-09-30 01:06:53'),
(41, 'Produit 14', '', '', '', '', '', '', '', 0, 0, 977, 5, 'catalog/demo/imac_1.jpg', 8, 1, '100.0000', 0, 9, '2009-02-03', '5.00000000', 1, '0.00000000', '0.00000000', '0.00000000', 1, 1, 1, 0, 1, 0, '2009-02-03 21:07:26', '2011-09-30 01:06:44'),
(42, 'Produit 15', '', '', '', '', '', '', '', 0, 0, 990, 5, 'catalog/demo/apple_cinema_30.jpg', 8, 1, '100.0000', 400, 9, '2009-02-04', '12.50000000', 1, '1.00000000', '2.00000000', '3.00000000', 1, 1, 2, 0, 1, 0, '2009-02-03 21:07:37', '2011-09-30 00:46:19'),
(43, 'Produit 16', '', '', '', '', '', '', '', 0, 0, 929, 5, 'catalog/demo/macbook_1.jpg', 8, 0, '500.0000', 0, 9, '2009-02-03', '0.00000000', 1, '0.00000000', '0.00000000', '0.00000000', 2, 1, 1, 0, 1, 0, '2009-02-03 21:07:49', '2011-09-30 01:05:46'),
(44, 'Produit 17', '', '', '', '', '', '', '', 0, 0, 1000, 5, 'catalog/demo/macbook_air_1.jpg', 8, 1, '1000.0000', 0, 9, '2009-02-03', '0.00000000', 1, '0.00000000', '0.00000000', '0.00000000', 2, 1, 1, 0, 1, 0, '2009-02-03 21:08:00', '2011-09-30 01:05:53'),
(45, 'Produit 18', '', '', '', '', '', '', '', 0, 0, 998, 5, 'catalog/demo/macbook_pro_1.jpg', 8, 1, '2000.0000', 0, 100, '2009-02-03', '0.00000000', 1, '0.00000000', '0.00000000', '0.00000000', 2, 1, 1, 0, 1, 0, '2009-02-03 21:08:17', '2011-09-15 22:22:01'),
(46, 'Produit 19', '', '', '', '', '', '', '', 0, 0, 1000, 5, 'catalog/demo/sony_vaio_1.jpg', 10, 1, '1000.0000', 0, 9, '2009-02-03', '0.00000000', 1, '0.00000000', '0.00000000', '0.00000000', 2, 1, 1, 0, 1, 0, '2009-02-03 21:08:29', '2011-09-30 01:06:39'),
(47, 'Produit 21', '', '', '', '', '', '', '', 0, 0, 1000, 5, 'catalog/demo/hp_1.jpg', 7, 1, '100.0000', 400, 9, '2009-02-03', '1.00000000', 1, '0.00000000', '0.00000000', '0.00000000', 1, 0, 1, 0, 1, 0, '2009-02-03 21:08:40', '2011-09-30 01:05:28'),
(48, 'Produit 20', 'test 1', '', '', '', '', '', 'test 2', 0, 0, 995, 5, 'catalog/demo/ipod_classic_1.jpg', 8, 1, '100.0000', 0, 9, '2009-02-08', '1.00000000', 1, '0.00000000', '0.00000000', '0.00000000', 2, 1, 1, 0, 1, 0, '2009-02-08 17:21:51', '2011-09-30 01:07:06'),
...
--
-- Dumping data for table `oc_product_attribute` MODIFICATION
--
...
(35, 2, 'Product 8', '&lt;p&gt;\r\n	Produit 8&lt;/p&gt;\r\n', '', 'Produit 8', '', ''),
(48, 2, 'iPod Classic','&lt;div class=&quot;cpt_product_description &quot;&gt;\r\n	&lt;div&gt;\r\n		&lt;p&gt;\r\n			&lt;strong&gt;Plus de place pour bouger&lt;/strong&gt;&lt;/p&gt;\r\n		&lt;p&gt;\r\n			Avec un stockage de 80 ou 160 Go et une autonomie pouvant atteindre 40 heures, le nouvel iPod classic vous permet de profiter de 40 000 chansons ou de 200 heures de vidéo ou toutes autres combinaisons, et cela où que vous alliez.&lt;/p&gt;\r\n		&lt;p&gt;\r\n			&lt;strong&gt;Cover Flow.&lt;/strong&gt;&lt;/p&gt;\r\n		&lt;p&gt;\r\n			Parcourez votre collection de musique en feuilletant les pochettes d''album. Sélectionnez un album pour l''ouvrir et voir la liste des pistes.&lt;/p&gt;\r\n		&lt;p&gt;\r\n			&lt;strong&gt;Interface améliorée.&lt;/strong&gt;&lt;/p&gt;\r\n		&lt;p&gt;\r\n			Découvrez une toute nouvelle façon de parcourir et de visualiser votre musique et vos vidéos.&lt;/p&gt;\r\n		&lt;p&gt;\r\n			&lt;strong&gt;Design plus élégant.&lt;/strong&gt;&lt;/p&gt;\r\n		&lt;p&gt;\r\n			Beau, durable et élégant, iPod Classic se présente sous un boîtier en aluminium anodisé en acier inoxydable poli aux bords arrondis.&lt;/p&gt;\r\n	&lt;/div&gt;\r\n&lt;/div&gt;\r\n&lt;!-- cpt_container_end --&gt;','','iPod Classic','',''),
(40, 2, 'iPhone','&lt;p class=&quot;intro&quot;&gt;\r\n	iPhone est un nouveau téléphone mobile révolutionnaire qui vous permet de passer un appel en appuyant simplement sur un nom ou un numéro dans votre carnet d''adresses, une liste de favoris ou un journal des appels. Il synchronise également automatiquement tous vos contacts depuis un PC, un Mac ou un service Internet. Et il vous permet de sélectionner et d''écouter les messages vocaux dans l''ordre que vous voulez, tout comme le courrier électronique.&lt;/p&gt;\r\n', '', 'iPhone', '', ''),
(28, 2, 'HTC Touch HD', '&lt;p&gt;\r\n	HTC Touch - en haute définition. Regardez des vidéos de musique et du contenu en streaming en haute définition avec une clarté impressionnante pour une expérience mobile que vous n''auriez jamais cru possible. Séduisant, élégant, le HTC Touch HD inaugure la nouvelle génération de fonctionnalités mobiles, le tout d''un simple toucher. Entièrement intégré à Windows Mobile Professionnel 6.1, 3.5G ultra rapide, GPS, appareil photo 5MP, et bien d’autres encore, le tout sur un écran tactile WVGA de 3,8 pouces à couper le souffle: vous pouvez prendre le contrôle de votre monde mobile avec le HTC Touch HD.&lt;/p&gt;\r\n&lt;p&gt;\r\n	&lt;strong&gt;Caractéristiques&lt;/strong&gt;&lt;/p&gt;\r\n&lt;ul&gt;\r\n	&lt;li&gt;\r\n		Processeur Qualcomm® MSM 7201A™ 528 MHz&lt;/li&gt;\r\n	&lt;li&gt;\r\n		Système d''exploitation Windows Mobile® 6.1 Professionnel&lt;/li&gt;\r\n	&lt;li&gt;\r\n		Mémoire: 512 MB ROM, 288 MB RAM&lt;/li&gt;\r\n	&lt;li&gt;\r\n		Dimensions: 115 mm x 62.8 mm x 12 mm / 146.4 grammes&lt;/li&gt;\r\n	&lt;li&gt;\r\n		Ecran tactile tactile TFT-LCD 3,8 pouces avec résolution WVGA 480 x 800&lt;/li&gt;\r\n	&lt;li&gt;\r\n		HSDPA/WCDMA: Europe/Asie: 900/2100 MHz; Jusqu''à 2 Mbps de liaisons montante et 7.2 Mbps de liaisons descendante&lt;/li&gt;\r\n	&lt;li&gt;\r\n		Quadribande GSM/GPRS/EDGE: Europe/Asie: 850/900/1800/1900 MHz (La fréquence de bande, la disponibilité HSUPA et la vitesse des données dépendent de l''opérateur.)&lt;/li&gt;\r\n	&lt;li&gt;Contrôle de l''appareil via le HTC TouchFLO™ 3D et boutons du panneau avant sensibles au toucher&lt;/li&gt;\r\n	&lt;li&gt;\r\n		GPS and A-GPS ready&lt;/li&gt;\r\n	&lt;li&gt;\r\n		Bluetooth® 2.0 avec Enhanced Data Rate et A2DP pour les casques stéréo sans fil&lt;br&gt;&lt;/li&gt;\r\n	&lt;li&gt;\r\n		Wi-Fi®: IEEE 802.11 b/g&lt;/li&gt;\r\n	&lt;li&gt;HTC ExtUSB™ (mini-USB 2.0 à 11 broches)&lt;/li&gt;\r\n	&lt;li&gt;Appareil photo couleur de 5 mégapixels avec mise au point automatique&lt;/li&gt;\r\n	&lt;li&gt;Caméra couleur VGA CMOS&lt;/li&gt;\r\n	&lt;li&gt;Prise audio 3,5 mm intégrée, microphone, haut-parleur et radio FM&lt;/li&gt;\r\n	&lt;li&gt;Formats de sonnerie : AAC, AAC+, eAAC+, AMR-NB, AMR-WB, QCP, MP3, WMA, WAV&lt;/li&gt;\r\n	&lt;li&gt;40 format polyphonique et standard MIDI 0 et 1 (SMF)/SP MIDI&lt;/li&gt;\r\n	&lt;li&gt;Batterie rechargeable Lithium-ion ou Lithium-ion polymère 1350 mAh&lt;/li&gt;\r\n	&lt;li&gt;Fente d''extension : microSD™ carte mémoire (compatible SD 2.0)&lt;/li&gt;\r\n	&lt;li&gt;Adaptateur AC Plage de tension/fréquence : 100 ~ 240V AC, sortie DC 50/60 Hz : 5V et 1A&lt;/li&gt;\r\n	&lt;li&gt;Caractéristiques spéciales : Radio FM, Capteur G&lt;/li&gt;\r\n&lt;/ul&gt;\r\n', '', 'HTC Touch HD', '', ''),
(44, 2, 'MacBook Air','&lt;div&gt;\r\n	Le MacBook Air est ultra-mince, ultra-portable, et ne ressemble à rien d''autre. Mais on ne perd pas des kilos et des centimètres en une nuit. C''est le résultat d''une remise en question des conventions. De multiples innovations sans fil. Et d''une conception révolutionnaire. Avec le MacBook Air, l''informatique mobile a soudain un nouveau standard.&lt;/div&gt;','','MacBook Air','',''),
(45, 2, 'MacBook Pro', '&lt;div class=&quot;cpt_product_description &quot;&gt;\r\n	&lt;div&gt;\r\n		&lt;p&gt;\r\n			&lt;b&gt;Dernière architecture mobile Intel&lt;/b&gt;&lt;/p&gt;\r\n		&lt;p&gt;\r\n			Alimenté par les processeurs mobiles les plus avancés d''Intel, le nouveau MacBook Pro Core 2 Duo est plus de 50% plus rapide que le MacBook Pro Core Duo original et supporte désormais jusqu''à 4 Go de RAM.&lt;/p&gt;\r\n		&lt;p&gt;\r\n			&lt;b&gt;Des graphismes de pointe&lt;/b&gt;&lt;/p&gt;\r\n		&lt;p&gt;\r\n			Le NVIDIA GeForce 8600M GT offre une puissance de traitement graphique exceptionnelle. Pour un canevas créatif ultime, vous pouvez même configurer le modèle 17 pouces avec un écran d''une résolution de 1920 x 1200.&lt;/p&gt;\r\n		&lt;p&gt;\r\n			&lt;b&gt;Conçu pour la vie sur la route&lt;/b&gt;&lt;/p&gt;\r\n		&lt;p&gt;\r\n			Des innovations telles qu''une connexion d''alimentation magnétique et un clavier éclairé avec capteur de lumière ambiante placent le MacBook Pro dans une classe à part.&lt;/p&gt;\r\n		&lt;p&gt;\r\n			&lt;b&gt;Connectez-vous. Créer. Communiquer.&lt;/b&gt;&lt;/p&gt;\r\n		&lt;p&gt;\r\n			Installez rapidement une vidéoconférence avec la caméra iSight intégrée. Contrôlez les présentations et les médias jusqu''à une distance de 9 mètres avec la télécommande Apple incluse. Connectez-vous à des périphériques à large bande passante avec FireWire 800 et DVI.&lt;/p&gt;\r\n		&lt;p&gt;\r\n			&lt;b&gt;Le sans-fil de nouvelle génération&lt;/b&gt;&lt;/p&gt;\r\n		&lt;p&gt;\r\n			Doté de la technologie sans fil 802.11n, le MacBook Pro offre jusqu''à cinq fois plus de performances et jusqu''à deux fois plus de possibilités que les technologies de la génération précédente.&lt;/p&gt;\r\n	&lt;/div&gt;\r\n&lt;/div&gt;\r\n&lt;!-- cpt_container_end --&gt;', '' , 'MacBook Pro','',''),
(29, 2, 'Palm Treo Pro', '&lt;p&gt;\r\n	Redéfinissez votre journée de travail avec le smartphone Palm Treo Pro. Parfaitement équilibré, il vous permet de répondre à vos courriels professionnels et personnels, de suivre vos rendez-vous et vos contacts, et d''utiliser le Wi-Fi ou le GPS lorsque vous êtes en déplacement. Regardez ensuite une vidéo sur YouTube, suivez l''actualité et les sports sur le web ou écoutez quelques chansons. Équilibrez votre travail et jouez comme vous l''aimez, avec le Palm Treo Pro.\r\n&lt;/p&gt;\r\n&lt;p&gt;\r\n	&lt;strong&gt;Caractéristiques&lt;/strong&gt;\r\n&lt;/p&gt;\r\n&lt;ul&gt;\r\n	&lt;li&gt;\r\n		Windows Mobile® 6.1 Professional Edition&lt;/li&gt;\r\n	&lt;li&gt;\r\n		Processeur Qualcomm® MSM7201 400MHz&lt;/li&gt;\r\n	&lt;li&gt;\r\n		Écran tactile TFT couleur transflectif 320x320&lt;/li&gt;\r\n	&lt;li&gt;\r\n		HSDPA/UMTS/EDGE/GPRS/GSM radio&lt;/li&gt;\r\n	&lt;li&gt;\r\n		UMTS tri-bande - 850MHz, 1900MHz, 2100MHz&lt;/li&gt;\r\n	&lt;li&gt;\r\n		GSM quadri-bande - 850/900/1800/1900&lt;/li&gt;\r\n	&lt;li&gt;\r\n		802.11b/g avec authentification WPA, WPA2 et 801.1x&lt;/li&gt;\r\n	&lt;li&gt;\r\n		GPS intégré&lt;/li&gt;\r\n	&lt;li&gt;\r\n		Version Bluetooth : 2.0 + débit de données amélioré&lt;/li&gt;\r\n	&lt;li&gt;\r\n		256 Mo de stockage (100 Mo d''utilisateur disponible), 128 Mo de RAM&lt;/li&gt;\r\n	&lt;li&gt;\r\n		Appareil photo de 2,0 mégapixels, zoom numérique jusqu''à 8x et capture vidéo &lt;/li&gt;\r\n	&lt;li&gt;\r\n		Batterie lithium-ion amovible et rechargeable de 1500mAh&lt;/li&gt;\r\n	&lt;li&gt;\r\n		Jusqu''à 5 heures de conversation et jusqu''à 250 heures de veille&lt;/li&gt;\r\n	&lt;li&gt;\r\n		Extension de la carte MicroSDHC (jusqu''à 32 Go)&lt;/li&gt;\r\n	&lt;li&gt;\r\n		MicroUSB 2.0 pour la synchronisation et le chargement&lt;/li&gt;\r\n	&lt;li&gt;\r\n		Prise casque stéréo 3,5 mm&lt;/li&gt;\r\n	&lt;li&gt;\r\n		60mm (L) x 114mm (L) x 13,5mm (P) / 133g&lt;/li&gt;\r\n&lt;/ul&gt;','','Palm Treo Pro','',''),
(36, 2, 'iPod Nano', '&lt;div&gt;\r\n	&lt;p&gt;\r\n		&lt;strong&gt;La vidéo dans votre poche.&lt;/strong&gt;&lt;/p&gt;\r\n	&lt;p&gt;\r\n		C''est le petit iPod avec une très grande idée : la vidéo. Le lecteur de musique le plus populaire au monde vous permet désormais de regarder des films, des émissions de télévision et bien plus encore sur un écran de deux pouces, 65 % plus lumineux qu''auparavant.&lt;/p&gt;\r\n	&lt;p&gt;\r\n		&lt;strong&gt;Cover Flow.&lt;/strong&gt;&lt;/p&gt;\r\n	&lt;p&gt;\r\n		Parcourez votre collection de musique en feuilletant les pochettes d''album. Sélectionnez un album pour le retourner et voir la liste des pistes.&lt;strong&gt;&amp;nbsp;&lt;/strong&gt;&lt;/p&gt;\r\n	&lt;p&gt;\r\n		&lt;strong&gt;Interface améliorée.&lt;/strong&gt;&lt;/p&gt;\r\n	&lt;p&gt;\r\n		Découvrez une toute nouvelle façon de naviguer et de visionner votre musique et vos vidéos.&lt;/p&gt;\r\n	&lt;p&gt;\r\n		&lt;strong&gt;Lisse et coloré.&lt;/strong&gt;&lt;/p&gt;\r\n	&lt;p&gt;\r\n		Avec un boîtier en aluminium anodisé et en acier inoxydable poli et un choix de cinq couleurs, l''iPod nano est habillé pour impressionner.&lt;/p&gt;\r\n	&lt;p&gt;\r\n		&lt;strong&gt;iTunes.&lt;/strong&gt;&lt;/p&gt;\r\n	&lt;p&gt;\r\n		Disponible en téléchargement gratuit, iTunes permet de parcourir et d''acheter facilement des millions de chansons, de films, d''émissions de télévision, de livres audio et de jeux et de télécharger des podcasts gratuits sur l''iTunes Store. Vous pouvez également importer votre propre musique, gérer toute votre bibliothèque de médias et synchroniser votre iPod ou iPhone en toute simplicité.&lt;/p&gt;\r\n&lt;/div&gt;\r\n','','iPod Nano','',''),
(46, 2, 'Sony VAIO', '&lt;div&gt;\r\n	Un pouvoir sans précédent. La prochaine génération de technologie de traitement est arrivée. La toute dernière innovation d''Intel, la plus puissante à ce jour, est intégrée dans les derniers ordinateurs portables VAIO. La technologie de processeur Intel® Centrino® 2. Doté d''une vitesse incroyable, d''une connectivité sans fil étendue, d''une prise en charge multimédia améliorée et d''une plus grande efficacité énergétique, tous les éléments essentiels de haute performance sont réunis de manière transparente dans une seule puce.&lt;/div&gt;','','Sony VAIO','',''),
(47 ,2, 'HP LP3065', '&lt;p&gt;\r\n	Arrêtez vos collègues dans leur élan avec le nouveau moniteur plat HP LP3065 de 30 pouces de diagonale. Ce moniteur offre les meilleures performances et les meilleures fonctions de présentation de sa catégorie sur un immense écran large tout en vous permettant de travailler aussi confortablement que possible - vous pourriez même oublier que vous êtes au bureau.&lt;/p&gt;','','HP LP3065','',''),
(32, 2, 'iPod Touch', '&lt;p&gt;\r\n	&lt;strong&gt;Interface multi-touch révolutionnaire.&lt;/strong&gt;&lt;br&gt;\r\n	L''iPod touch est doté de la même technologie d''écran multi-touch que l''iPhone. Pincez pour zoomer sur une photo. Faites défiler vos chansons et vos vidéos d''un simple coup d''œil. Feuilletez votre bibliothèque par pochette d''album avec Cover Flow.&lt;/p&gt;\r\n&lt;p&gt;\r\n	&lt;strong&gt;Superbe écran large de 3,5 pouces.&lt;/strong&gt;&lt;br&gt;\r\n	Regardez vos films, émissions de télévision et photos s''animer grâce aux couleurs vives et éclatantes de l''écran de 320 x 480 pixels.&lt;/p&gt;\r\n&lt;p&gt;\r\n	&lt;strong&gt;Téléchargement de musique directement à partir d''iTunes.&lt;/strong&gt;&lt;br&gt;\r\n	Achetez le iTunes Wi-Fi Music Store de n''importe où grâce au Wi-Fi. Naviguez ou faites une recherche pour trouver la musique que vous recherchez, prévisualisez-la et achetez-la d''un simple coup.&lt;/p&gt;\r\n&lt;p&gt;\r\n	&lt;strong&gt;Surfez sur le web avec le Wi-Fi.&lt;/strong&gt;&lt;br&gt;\r\n	Naviguer sur le web en utilisant Safari et regarder des vidéos YouTube sur le premier iPod avec Wi-Fi intégré&lt;br&gt;\r\n	&amp;nbsp;&lt;/p&gt;','','	 iPod Touch','',''),
(41, 2, 'iMac', '&lt;div&gt;\r\n	Alors que vous pensiez qu''iMac avait tout, maintenant il y a encore plus. Des processeurs Intel Core 2 Duo plus puissants. Et plus de mémoire standard. Combiné à Mac OS X Leopard et iLife ''08, c''est le tout-en-un le plus complet qui soit. iMac offre des performances étonnantes dans un espace étonnamment réduit.&lt;/div&gt;','','iMac','',''),
(33, 2, 'Samsung SyncMaster 941BW', '&lt;div&gt;\r\n	Imaginez les avantages d''aller loin sans ralentir. Le grand écran 19&quot; 941BW combine un grand format d''image avec un temps de réponse rapide des pixels, pour des images plus grandes, plus d''espace pour travailler et des mouvements plus nets. De plus, les technologies exclusives MagicBright 2, MagicColor et MagicTune permettent d''obtenir l''image idéale dans toutes les situations, tandis que le cadre étroit et élégant ainsi que les pieds réglables délivre le style que vous souhaitez. Avec le moniteur LCD Samsung 941BW à écran large analogique/numérique, ce n''est pas difficile à imaginer.&lt;/div&gt;','','Samsung SyncMaster 941BW','',''),
(34, 2, 'iPod Shuffle', '&lt;div&gt;\r\n	&lt;strong&gt;Né pour être porté.&lt;/strong&gt;\r\n	&lt;p&gt;\r\n		Découvrez le lecteur de musique le plus portable au monde et emportez jusqu''à 240 chansons partout avec vous. Choisissez parmi cinq couleurs, dont quatre nouvelles teintes, pour exprimer votre mode musicale.&lt;/p&gt;\r\n	&lt;p&gt;\r\n		&lt;strong&gt;Le hasard rencontre le rythme.&lt;/strong&gt;&lt;/p&gt;\r\n	&lt;p&gt;\r\n		Grâce au remplissage automatique d''iTunes, l''iPod shuffle peut offrir une nouvelle expérience musicale à chaque fois que vous vous synchronisez. Pour plus de hasard, vous pouvez mélanger les chansons pendant la lecture en faisant glisser l''interrupteur.&lt;/p&gt;\r\n	&lt;strong&gt;Tout est facile.&lt;/strong&gt;\r\n	&lt;p&gt;\r\n		Chargez et synchronisez avec la station d''accueil USB incluse. Utilisez les commandes de l''iPod shuffle d''une seule main. Profitez jusqu''à 12 heures d''affilée de lecture de musique sans interruption.&lt;/p&gt;\r\n&lt;/div&gt;\r\n','','iPod Shuffle','',''),
(43, 2, 'MacBook', '&lt;div&gt;\r\n	&lt;p&gt;\r\n		&lt;b&gt;Processeur Intel Core 2 Duo&lt;/b&gt;&lt;/p&gt;\r\n	&lt;p&gt;\r\n		Alimenté par un processeur Intel Core 2 Duo à des vitesses allant jusqu''à 2,16 GHz, le nouveau MacBook est le plus rapide jamais réalisé.&lt;/p&gt;\r\n	&lt;p&gt;\r\n		&lt;b&gt;Mémoire de 1 Go, disques durs plus grands&lt;/b&gt;&lt;/p&gt;\r\n	&lt;p&gt;\r\n		Le nouveau MacBook est désormais doté d''une mémoire standard de 1 Go et de disques durs plus grands pour toute la gamme, parfaits pour exécuter davantage de vos applications favorites et stocker des collections multimédia croissantes.&lt;/p&gt;\r\n	&lt;p&gt;\r\n		&lt;b&gt;Design épuré, 1,08 pouce d''épaisseur&lt;/b&gt;&lt;/p&gt;\r\n	&lt;p&gt;\r\n		Le MacBook est facile à emporter sur la route grâce à son boîtier en polycarbonate résistant, aux technologies sans fil intégrées et à l''adaptateur secteur MagSafe innovant qui se détache automatiquement si quelqu''un trébuche accidentellement sur le cordon.&lt;/p&gt;\r\n	&lt;p&gt;\r\n		&lt;b&gt;Caméra iSight intégrée&lt;/b&gt;&lt;/p&gt;\r\n	&lt;p&gt;\r\n		Dès la sortie de la boîte, vous pouvez chatter en vidéo avec vos amis ou votre famille , enregistrer une vidéo à votre bureau ou prendre des photos amusantes avec Photo Booth&lt;/p&gt;\r\n&lt;/div&gt;\r\n','','MacBook','',''),
(31, 2, 'Nikon D300', '&lt;div class=&quot;cpt_product_description &quot;&gt;\r\n	&lt;div&gt;\r\n		Conçu avec des caractéristiques et des performances de niveau professionnel, le D300 de 12,3 mégapixels combine de toutes nouvelles technologies avec des caractéristiques avancées héritées du nouvel appareil reflex numérique professionnel D3 de Nikon, récemment annoncé, pour offrir aux photographes des performances remarquables associées à une grande agilité.&lt;br&gt;\r\n		&lt;br&gt;\r\n		Tout comme le D3, le D300 est équipé du système de traitement d''image EXPEED exclusif à Nikon, qui joue un rôle central dans l''obtention de la vitesse et de la puissance de traitement nécessaires à la plupart des nouvelles fonctions de l''appareil. Le D300 est doté d''un nouveau système autofocus à 51 points avec la fonction de suivi de la mise au point 3D de Nikon et de deux nouveaux modes de prise de vue LiveView qui permettent aux utilisateurs de cadrer une photo en utilisant l''écran LCD haute résolution de l''appareil. Le D300 partage un système de reconnaissance de scène similaire à celui du D3 ; il promet d''améliorer considérablement la précision de l''autofocus, de l''exposition automatique et de la balance des blancs automatique en reconnaissant le sujet ou la scène photographiée et en appliquant ces informations aux calculs des trois fonctions.&lt;br&gt;\r\n		&lt;br&gt;\r\n		Le D300 réagit à la vitesse de l''éclair, se met en marche en seulement 0,13 seconde et prend des photos avec un délai de déclenchement imperceptible de 45 millisecondes. Le D300 est capable de prendre des photos à une vitesse de six images par seconde et peut aller jusqu''à huit images par seconde lorsqu''il utilise le bloc-piles MB-D10 en option. En rafale continue, le D300 peut prendre jusqu''à 100 photos à la pleine résolution de 12,3 mégapixels. (Réglage d''image NORMAL-LARGE, en utilisant une carte CompactFlash SanDisk Extreme IV de 1 Go).&lt;br&gt;\r\n		&lt;br&gt;\r\n		Le D300 intègre une série de technologies et de caractéristiques innovantes qui amélioreront considérablement la précision, le contrôle et les performances que les photographes peuvent obtenir de leur équipement. Son nouveau système de reconnaissance de scènes fait progresser l''utilisation du célèbre capteur Nikon à 1 005 segments pour reconnaître les couleurs et les motifs lumineux qui aident l''appareil photo à déterminer le sujet et le type de scène à photographier avant la prise de vue. Ces informations sont utilisées pour améliorer la précision des fonctions de mise au point automatique, d''exposition automatique et de balance des blancs automatique du D300. Par exemple, l''appareil photo peut mieux suivre les sujets en mouvement et, en les identifiant, il peut également sélectionner automatiquement les points de mise au point plus rapidement et avec une plus grande précision. Il peut également analyser les points de mise au point et déterminer plus précisément l''exposition, ainsi que déduire les sources de lumière pour fournir une détection plus précise de la balance des blancs.&lt;/div&gt;\r\n&lt;/div&gt;','','Nikon D300','',''),
(49, 2, 'Samsung Galaxy Tab 10.1', '&lt;p&gt;\r\n	Le Samsung Galaxy Tab 10.1, est la tablette la plus fine du monde, avec une épaisseur de 8,6 mm, fonctionnant sous Android 3.0 Honeycomb OS sur un processeur Tegra 2 double cœur à 1 GHz, similaire à son petit frère Samsung Galaxy Tab 8.9.&lt;/p&gt;\r\n&lt;p&gt;  \r\n	Le Samsung Galaxy Tab 10.1 offre une expérience Android 3.0 pure, en ajoutant son nouveau TouchWiz UX ou TouchWiz 4.0 - Inclus avec un panel d''outils, qui vous permette de le personnaliser avec différents contenus, tels que vos photos, vos signets et vos flux sociaux, arborant un écran tactile 10. 1 pouce WXGA avec une résolution de 1280 x 800 pixels, équipé d''un appareil photo arrière de 3 mégapixels avec flash LED et d''un appareil photo avant de 2 mégapixels, connectivité HSPA+ jusqu''à 21Mbps, capacité d''enregistrement vidéo HD 720p, lecture HD 1080p, support DLNA, Bluetooth 2. 1, USB 2.0, gyroscope, Wi-Fi 802.11 a/b/g/n, fente micro-SD, prise casque 3,5 mm et fente SIM, y compris la clé Samsung - un microphone Bluetooth qui peut être transporté dans une poche comme un stylo et une station d''accueil pour le son avec un caisson de basses alimenté.&lt;/p&gt;\r\n&lt;p&gt;  \r\n	Le Samsung Galaxy Tab 10.1 sera disponible en 16GB / 32GB / 64GB et préchargé avec Social Hub, Reader''s Hub, Music Hub et Samsung Mini Apps Tray - qui vous donne accès aux applications les plus courantes pour faciliter le multitâche. Il est également compatible avec Adobe Flash Player 10.2, alimenté par une batterie de 6860mAh qui vous donne 10 heures de lecture vidéo.  &lt;br&gt;&lt;/p&gt;','','Samsung Galaxy Tab 10.1','',''),
(42, 2, 'Apple Cinema 30&quot;', '&lt;p&gt;\r\n	&lt;font size=&quot;2&quot; face=&quot;helvetica,geneva,arial&quot;&gt;&lt;font size=&quot;2&quot; face=&quot;Helvetica&quot;&gt;L’écran Apple Cinema HD 30 pouces offre une incroyable résolution de 2560x1600 pixels. Conçu spécialement pour des professionnels créatifs, cet écran offre plus d''espace pour un accès plus facile à tous les outils et palettes nécessaire pour éditer, formater et composer vos travaux. Combinez cet écran avec un Mac Pro, MacBook Pro, ou un PowerMac G5 et rien ne vous sera plus jamais impossible.&lt;br&gt;\r\n	&lt;br&gt;\r\n	&lt;/font&gt;&lt;font size=&quot;2&quot; face=&quot;Helvetica&quot;&gt;L’écran Cinema HD dispose d''un écran à cristaux liquides à matrice active qui produit des images sans scintillement offrant ainsi une luminosité deux fois plus élevée, une netteté d’image deux fois plus élevée et un ratio de contraste deux fois plus élevée qu’un écran CRT typique. Comparé aux autres écran plats, il a été conçu avec une interface entièrement numérique ce qui permet de fournir des images sans distorsion qui n''ont jamais besoin d''être ajustées. Avec plus de  quatre millions de pixels numériques, l''écran est particulièrement adapté aux applications scientifiques et techniques telles que la visualisation de structures moléculaires ou l''analyse de données géologiques.&lt;br&gt;\r\n	&lt;br&gt;\r\n	&lt;/font&gt;&lt;font size=&quot;2&quot; face=&quot;Helvetica&quot;&gt;L’écran Cinema HD offre jusqu''à 16,7 millions de couleurs différentes permettant ainsi de voir les nuances subtiles entre les couleurs, des pastels les plus douces aux riches tons de bijoux. Son large angle de vue assure une couleur uniforme d''un bord à l''autre. La technologie ColorSync d''Apple vous permet de créer des profils personnalisés pour maintenir des couleurs homogènes à l''écran et à l''impression. Le résultat : vous pouvez utiliser cet écran en toute confiance dans toutes vos applications où les couleurs sont essentielles. &lt;br&gt;\r\n	&lt;br&gt;\r\n	&lt;/font&gt;&lt;font size=&quot;2&quot; face=&quot;Helvetica&quot;&gt;Le nouveau design en aluminium de l''écran est doté d''un habillage ultra-fin qui améliore la précision visuelle. Cet écran dispose de deux ports FireWire 400 et de deux ports USB 2.0, ce qui rend la connexion de périphériques de bureau, tels que iSight, iPod, appareils photo et appareils numériques, disques durs, imprimantes et scanners, encore plus accessible et pratique. Beaucoup plus fin et plus léger qu''un écran LCD, ce nouvel écran prend en charge la norme d''interface de montage VESA (Video Electronics Standards Association). Les clients disposant du kit d''adaptateur de montage VESA Cinema Display (en option) ont la possibilité d''installer leur écran dans les endroits les plus appropriés à leur environnement de travail.&lt;br&gt;\r\n	&lt;br&gt;\r\n	&lt;/font&gt;&lt;font size=&quot;2&quot; face=&quot;Helvetica&quot;&gt;Le Cinema HD est doté d''un câble unique avec une sortie pour l''USB 2.0, le FireWire 400 et une connexion numérique utilisant l''interface DVI (Digital Video Interface) utilisant le standard de l''industrie. La connexion DVI permet une connexion directe purement numérique.&lt;br&gt;\r\n	&lt;/font&gt;&lt;/font&gt;&lt;/p&gt;\r\n&lt;h3&gt;\r\n	Caractéristiques:&lt;/h3&gt;\r\n&lt;p&gt;\r\n	Des performances d''affichage inégalées&lt;/p&gt;\r\n&lt;ul&gt;\r\n	&lt;li&gt;\r\n		L''écran à cristaux liquides à matrice active de 30 pouces (visible) offre une qualité d''image époustouflante et des couleurs vives et richement saturées.&lt;/li&gt;\r\n	&lt;li&gt;\r\n		Prise en charge d''une résolution de 2560 x 1600 pixels pour l''affichage d''images fixes et vidéo haute définition.&lt;/li&gt;\r\n	&lt;li&gt;\r\n		Conception grand format pour l''affichage simultané de deux pages complètes de texte et de graphiques.&lt;/li&gt;\r\n	&lt;li&gt;\r\n		Connecteur DVI standard pour une connexion directe aux ordinateurs de bureau et portables Mac et Windows.&lt;/li&gt;\r\n	&lt;li&gt;\r\n		Angle de vision horizontal et vertical incroyablement large (170 degrés) pour une visibilité et des performances chromatiques maximales.&lt;/li&gt;\r\n	&lt;li&gt;\r\n		Réponse des pixels ultra-rapide pour la lecture de vidéos numériques en full-motion.&lt;/li&gt;\r\n	&lt;li&gt;\r\n		Prise en charge de 16,7 millions de couleurs, pour une utilisation dans toutes les applications graphiques intensives.&lt;/li&gt;\r\n&lt;/ul&gt;\r\n&lt;p&gt;\r\n	Une installation et un fonctionnement simple&lt;/p&gt;\r\n&lt;ul&gt;\r\n	&lt;li&gt;\r\n		Câble unique avec une élégante prise pour la connexion aux ports DVI, USB et FireWire.&lt;/li&gt;\r\n	&lt;li&gt;\r\n		Deux ports USB 2.0 intégrés pour une connexion facile des périphériques de bureau.&lt;/li&gt;\r\n	&lt;li&gt;\r\n		Deux ports FireWire 400 pour la prise en charge iSight et d''autres périphériques de bureau.&lt;/li&gt;\r\n&lt;/ul&gt;\r\n&lt;p&gt;\r\n	Un design épuré et élégant&lt;/p&gt;\r\n&lt;ul&gt;\r\n	&lt;li&gt;\r\n		Un énorme espace de travail virtuel et un encombrement très réduit.&lt;/li&gt;\r\n	&lt;li&gt;\r\n		Habillage ultra-fin pour minimiser l''impact visuel de l''utilisation d''un double affichage.&lt;/li&gt;\r\n	&lt;li&gt;\r\n		Conception unique de la charnière pour un ajustement sans effort.&lt;/li&gt;\r\n	&lt;li&gt;\r\n		Prise en charge des solutions de montage VESA (adaptateur Apple Cinema Display VESA vendu séparément).&lt;/li&gt;\r\n&lt;/ul&gt;\r\n&lt;h3&gt;\r\n	Spécificités techniques&lt;/h3&gt;\r\n&lt;p&gt;\r\n	&lt;b&gt;Taille de l''écran (taille de l''image visible en diagonale)&lt;/b&gt;&lt;/p&gt;\r\n&lt;ul&gt;\r\n	&lt;li&gt;\r\n		Ecran Apple Cinema HD : 30 pouces (29,7 pouces visible)&lt;/li&gt;\r\n&lt;/ul&gt;\r\n&lt;p&gt;\r\n	&lt;b&gt;Type d''écran&lt;/b&gt;&lt;/p&gt;\r\n&lt;ul&gt;\r\n	&lt;li&gt;\r\n		Écran à cristaux liquides à matrice active (AMLCD) à transistors en couches minces (TFT)&lt;/li&gt;\r\n&lt;/ul&gt;\r\n&lt;p&gt;\r\n	&lt;b&gt;Résolutions&lt;/b&gt;&lt;/p&gt;\r\n&lt;ul&gt;\r\n	&lt;li&gt;\r\n		2560 x 1600 pixels (résolution optimale)&lt;/li&gt;\r\n	&lt;li&gt;\r\n		2048 x 1280&lt;/li&gt;\r\n	&lt;li&gt;\r\n		1920 x 1200&lt;/li&gt;\r\n	&lt;li&gt;\r\n		1280 x 800&lt;/li&gt;\r\n	&lt;li&gt;\r\n		1024 x 640&lt;/li&gt;\r\n&lt;/ul&gt;\r\n&lt;p&gt;\r\n	&lt;b&gt;Couleurs d''affichage (maximum)&lt;/b&gt;&lt;/p&gt;\r\n&lt;ul&gt;\r\n	&lt;li&gt;\r\n		16.7 millions&lt;/li&gt;\r\n&lt;/ul&gt;\r\n&lt;p&gt;\r\n	&lt;b&gt;Angle de vue (standard)&lt;/b&gt;&lt;/p&gt;\r\n&lt;ul&gt;\r\n	&lt;li&gt;\r\n		170° horizontal; 170° vertical&lt;/li&gt;\r\n&lt;/ul&gt;\r\n&lt;p&gt;\r\n	&lt;b&gt;Luminosité (standard)&lt;/b&gt;&lt;/p&gt;\r\n&lt;ul&gt;\r\n	&lt;li&gt;\r\n		Écran de 30 pouces HD : 400 cd/m2&lt;/li&gt;\r\n&lt;/ul&gt;\r\n&lt;p&gt;\r\n	&lt;b&gt;Ratio de contraste (standard)&lt;/b&gt;&lt;/p&gt;\r\n&lt;ul&gt;\r\n	&lt;li&gt;\r\n		700:1&lt;/li&gt;\r\n&lt;/ul&gt;\r\n&lt;p&gt;\r\n	&lt;b&gt;Temps de réponse (standard)&lt;/b&gt;&lt;/p&gt;\r\n&lt;ul&gt;\r\n	&lt;li&gt;\r\n		16 ms&lt;/li&gt;\r\n&lt;/ul&gt;\r\n&lt;p&gt;\r\n	&lt;b&gt;Longueur du pas des pixels&lt;/b&gt;&lt;/p&gt;\r\n&lt;ul&gt;\r\n	&lt;li&gt;\r\n		Écran de 30 pouces HD : 0.250 mm&lt;/li&gt;\r\n&lt;/ul&gt;\r\n&lt;p&gt;\r\n	&lt;b&gt;Traitement de l''écran&lt;/b&gt;&lt;/p&gt;\r\n&lt;ul&gt;\r\n	&lt;li&gt;\r\n        Couche dure anti-reflet&lt;/li&gt;\r\n&lt;/ul&gt;\r\n&lt;p&gt;\r\n	&lt;b&gt;Commandes de l''utilisateur (matériel et logiciel)&lt;/b&gt;&lt;/p&gt;\r\n&lt;ul&gt;\r\n	&lt;li&gt;\r\n		Mise en marche&lt;/li&gt;\r\n	&lt;li&gt;\r\n		Mise en veille/réveil&lt;/li&gt;\r\n	&lt;li&gt;\r\n		Luminosité&lt;/li&gt;\r\n	&lt;li&gt;\r\n		Inclinaison du moniteur&lt;/li&gt;\r\n&lt;/ul&gt;\r\n&lt;p&gt;\r\n	&lt;b&gt;Connecteurs et câbles&lt;/b&gt;&lt;br&gt;\r\n	Câbles&lt;/p&gt;\r\n&lt;ul&gt;\r\n	&lt;li&gt;\r\n		DVI (Digital Visual Interface)&lt;/li&gt;\r\n	&lt;li&gt;\r\n		FireWire 400&lt;/li&gt;\r\n	&lt;li&gt;\r\n		USB 2.0&lt;/li&gt;\r\n	&lt;li&gt;\r\n        Alimentation en courant continu (24 V)&lt;/li&gt;\r\n&lt;/ul&gt;\r\n&lt;p&gt;\r\n	Connecteurs&lt;/p&gt;\r\n&lt;ul&gt;\r\n	&lt;li&gt;\r\n		2 ports USB 2.0 auto-alimentés&lt;/li&gt;\r\n	&lt;li&gt;\r\n		2 ports FireWire 400&lt;/li&gt;\r\n	&lt;li&gt;\r\n		1 Port sécurisé Kensington&lt;/li&gt;\r\n&lt;/ul&gt;\r\n&lt;p&gt;\r\n	&lt;b&gt;Adaptateur de montage VESA&lt;/b&gt;&lt;br&gt;\r\n	Nécessite l''adaptateur de montage VESA optionnel Cinema Display (M9649G/A)&lt;/p&gt;\r\n&lt;ul&gt;\r\n	&lt;li&gt;\r\n		Compatible avec les solutions de montage conformes à la norme VESA FDMI (MIS-D, 100, C)&lt;/li&gt;\r\n&lt;/ul&gt;\r\n&lt;p&gt;\r\n	&lt;b&gt;Exigences électriques&lt;/b&gt;&lt;/p&gt;\r\n&lt;ul&gt;\r\n	&lt;li&gt;\r\n		Tension d''entrée : 100-240 VAC 50-60Hz&lt;/li&gt;\r\n	&lt;li&gt;\r\n		Puissance maximale en fonctionnement : 150W&lt;/li&gt;\r\n	&lt;li&gt;\r\n		Mode économie d''énergie : 3W ou moins&lt;/li&gt;\r\n&lt;/ul&gt;\r\n&lt;p&gt;\r\n	&lt;b&gt;Exigences environnementales&lt;/b&gt;&lt;/p&gt;\r\n&lt;ul&gt;\r\n	&lt;li&gt;\r\n		Température de fonctionnement : 50° à 95° F (10° à 35° C)&lt;/li&gt;\r\n	&lt;li&gt;\r\n		Température de stockage : -40° à 116° F (-40° à 47° C)&lt;/li&gt;\r\n	&lt;li&gt;\r\n		Taux d''humidité : 20 à 80% sans condensation&lt;/li&gt;\r\n	&lt;li&gt;\r\n		Altitude maximale d''exploitation : 10 000 pieds&lt;/li&gt;\r\n&lt;/ul&gt;\r\n&lt;p&gt;\r\n	&lt;b&gt;Agréments des agences&lt;/b&gt;&lt;/p&gt;\r\n&lt;ul&gt;\r\n	&lt;li&gt;\r\n		FCC Part 15 Class B&lt;/li&gt;\r\n	&lt;li&gt;\r\n		EN55022 Class B&lt;/li&gt;\r\n	&lt;li&gt;\r\n		EN55024&lt;/li&gt;\r\n	&lt;li&gt;\r\n		VCCI Class B&lt;/li&gt;\r\n	&lt;li&gt;\r\n		AS/NZS 3548 Class B&lt;/li&gt;\r\n	&lt;li&gt;\r\n		CNS 13438 Class B&lt;/li&gt;\r\n	&lt;li&gt;\r\n		ICES-003 Class B&lt;/li&gt;\r\n	&lt;li&gt;\r\n		ISO 13406 part 2&lt;/li&gt;\r\n	&lt;li&gt;\r\n		MPR II&lt;/li&gt;\r\n	&lt;li&gt;\r\n		IEC 60950&lt;/li&gt;\r\n	&lt;li&gt;\r\n		UL 60950&lt;/li&gt;\r\n	&lt;li&gt;\r\n		CSA 60950&lt;/li&gt;\r\n	&lt;li&gt;\r\n		EN60950&lt;/li&gt;\r\n	&lt;li&gt;\r\n		ENERGY STAR&lt;/li&gt;\r\n	&lt;li&gt;\r\n		TCO ''03&lt;/li&gt;\r\n&lt;/ul&gt;\r\n&lt;p&gt;\r\n	&lt;b&gt;Taille et poids&lt;/b&gt;&lt;br&gt;\r\n	Écran Apple Cinema HD de 30 pouces&lt;/p&gt;\r\n&lt;ul&gt;\r\n	&lt;li&gt;\r\n		Hauteur : 54,3 cm (21,3 pouces)&lt;/li&gt;\r\n	&lt;li&gt;\r\n		Largeur : 68,8 cm (27,2 pouces)&lt;/li&gt;\r\n	&lt;li&gt;\r\n		Profondeur : 21,5 cm (8,46 pouces)&lt;/li&gt;\r\n	&lt;li&gt;\r\n		Poids : 27,5 livres (12,5 kg)&lt;/li&gt;\r\n&lt;/ul&gt;\r\n&lt;p&gt;\r\n	&lt;b&gt;Exigences système&lt;/b&gt;&lt;/p&gt;\r\n&lt;ul&gt;\r\n	&lt;li&gt;\r\n		Mac Pro, toutes options graphiques&lt;/li&gt;\r\n	&lt;li&gt;\r\n		MacBook Pro&lt;/li&gt;\r\n	&lt;li&gt;\r\n		Power Mac G5 (PCI-X) avec ATI Radeon 9650 ou supérieur ou NVIDIA GeForce 6800 GT DDL ou supérieur&lt;/li&gt;\r\n	&lt;li&gt;\r\n		Power Mac G5 (PCI Express), toutes options graphiques&lt;/li&gt;\r\n	&lt;li&gt;\r\n		PowerBook G4 avec support DVI dual-link&lt;/li&gt;\r\n	&lt;li&gt;\r\n		PC et carte graphique Windows prenant en charge les ports DVI dual-link et supportant la norme VESA DDC pour une installation plug-and-play&lt;/li&gt;\r\n &lt;/ul&gt;','','Apple Cinema 30','',''),
(30, 2, 'Canon EOS 5D', '&lt;p&gt;\r\n	La revue de presse de Canon pour l''EOS 5D indique qu''il &quot;définit une nouvelle catégorie de D-SLR&quot;, alors que nous ne sommes généralement pas trop préoccupés par les discours marketing - cette déclaration particulière est clairement assez précise. L''EOS 5D n''est pas un reflex numérique comme les autres, car il combine un capteur haute résolution (12,8 mégapixels) pleine écran (35 mm) et un boîtier relativement compact (légèrement plus grand que l''EOS 20D, bien qu''il semble plus &quot;gros&quot; dans votre main). L''EOS 5D est destiné à se glisser entre l''EOS 20D et l''EOS-1D, un reflex numérique professionnel. Une différence importante par rapport à ce dernier est que l''EOS 5D n''a pas de label environnemental. Bien que Canon ne désigne pas spécifiquement l''EOS 5D comme un reflex numérique &quot;professionnel&quot;, il intéressera manifestement les professionnels qui souhaitent un reflex numérique de haute qualité dans un boîtier plus léger que l''EOS-1D. Il séduira aussi sans doute les propriétaires actuels d''EOS 20D (en espérant toutefois qu''ils n''aient pas acheté trop d''objectifs EF-S...) &lt;br&gt;&lt;/p&gt;','','sdf','','');
...
--
-- Dumping data for table `oc_return_action` MODIFICATION
--
...
(1, 2, 'Remboursé'),
(2, 2, "Avoir émis"),
(3, 2, 'Article de remplacement envoyé');


-----------------------------------------------------------

--
-- Dumping data for table `oc_return_reason` MODIFICATION
--
...
(1, 2, 'L''article ainsi que son emballage extérieur sont endommagés - Veuillez fournir des informations détaillées'),
(2, 2, 'L''emballage extérieur est intact, mais l''article est endommagé -  Veuillez fournir des informations détaillées'),
(3, 2, 'L''article est différent de ce qui a été commandé - Veuillez fournir des informations détaillées'),
(4, 2, 'Erreur sur la commande - Veuillez fournir des informations détaillées'),
(5, 2, 'Article défectueux - Veuillez fournir des informations détaillées'),
(6, 2, 'Autres - Veuillez fournir des informations détaillées');

-----------------------------------------------------------

--
-- Dumping data for table `oc_return_status` MODIFICATION
--
...
(1, 2, 'En attente'),
(3, 2, 'Achevée'),
(2, 2, 'En attente Produit(s)');

-----------------------------------------------------------

--
-- Dumping data for table `oc_setting` MODIFICATION
--
...
(0, 'config', 'config_meta_title', 'Votre boutique', 0),
(0, 'config', 'config_session_expire', '3600000000', 0),
(0, 'config', 'config_meta_description', 'Ma boutique', 0),
(0, 'config', 'config_meta_keyword', '', 0),
(0, 'config', 'config_theme', 'basic', 0),
(0, 'config', 'config_layout_id', '4', 0),
(0, 'config', 'config_country_id', '74', 0),
(0, 'config', 'config_zone_id', '', 0),
(0, 'config', 'config_timezone', 'Europe/Paris', 0),
(0, 'config', 'config_language', 'fr-FR', 0),
...
(0, 'config', 'config_address', 'Addresse 1', 0),
(0, 'config', 'config_name', 'Boutique', 0),
...
--
-- Dumping data for table `oc_seo_url` MODIFICATION
--
...
(0, 2, 'product_id', '47', 'hp-lp3065', 0),
(0, 2, 'product_id', '48', 'ipod-classic', 0),
(0, 2, 'product_id', '28', 'htc-touch-hd', 0),
(0, 2, 'product_id', '43', 'macbook', 0),
(0, 2, 'product_id', '44', 'macbook-air', 0),
(0, 2, 'product_id', '45', 'macbook-pro', 0),
(0, 2, 'product_id', '30', 'canon-eos-5d', 0),
(0, 2, 'product_id', '31', 'nikon-d300', 0),
(0, 2, 'product_id', '29', 'palm-treo-pro', 0),
(0, 2, 'product_id', '35', 'product-8', 0),
(0, 2, 'product_id', '49', 'samsung-galaxy-tab-10-1', 0),
(0, 2, 'product_id', '33', 'samsung-syncmaster-941bw', 0),
(0, 2, 'product_id', '46', 'sony-vaio', 0),
(0, 2, 'product_id', '41', 'imac', 0),
(0, 2, 'product_id', '40', 'iphone', 0),
(0, 2, 'product_id', '36', 'ipod-nano', 0),
(0, 2, 'product_id', '34', 'ipod-shuffle', 0),
(0, 2, 'product_id', '32', 'ipod-touch', 0),
(0, 2, 'product_id', '50', 'apple-4', 0),
(0, 2, 'product_id', '42', 'apple-cinema', 0),
...
--
-- Dumping data for table `oc_stock_status` MODIFICATION
--
...
--
-- Dumping data for table `oc_subscription_status` MODIFICATION
--
...
--
-- Dumping data for table `oc_user_group` MODIFICATION
--
...
--
-- Dumping data for table `oc_voucher_theme_description` MODIFICATION
--
...
--
-- Dumping data for table `oc_weight_class_description` MODIFICATION
--
